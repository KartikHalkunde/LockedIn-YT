...
- Select the generated `lockedin-1.0.81.zip` file
...
│   └── iconFull.png       # Full logo (dark mode)
|   ├── LockedOut.png         # Lockedin turned off (dark mode icon)
│   └── iconFullLight.png       # Full logo (light mode)
│   └── LightOff.png           # Lockedin turned off (light mode icon)
├── popup/
...
# The resulting lockedin-1.0.81.zip contains the exact same code
